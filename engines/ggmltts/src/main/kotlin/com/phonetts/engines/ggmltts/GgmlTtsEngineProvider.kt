...
/**
 * ServiceLoader entry point for the generalized GGUF/ggml engine module (see
 ...
 */
class GgmlTtsEngineProvider : EngineProvider {
    override val engineId: String = GgmlTtsEngine.ENGINE_ID

    override fun create(context: EngineContext): VoiceEngine = GgmlTtsEngine(context)
}
