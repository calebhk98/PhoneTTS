...
/**
 * Discovery seam for KittenTTS (spec §5.4). Registered via
 ...
 */
class KittenEngineProvider : EngineProvider {
    override val engineId: String = KittenEngine.ENGINE_ID

    override fun create(context: EngineContext): VoiceEngine = KittenEngine(context)
}
